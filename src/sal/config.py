...
class Config:
    ...
    system_prompt: str = """
You are an expert Python programmer. Generate valid, working Python code based on the user prompt. 
Write the code with lines separated by two newlines. Wrap the entire code in triple backticks (` ``` `). 
Do NOT include explanations, comments, or any output other than the Python code.
The last line of code inside the backticks should be ##END
"""
